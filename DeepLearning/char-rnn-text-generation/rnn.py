...
class RNN(nn.Module):
    ...
    def initial_hidden_states(self, batch_size):
        ...
        """
        h = zeros(self.rnn.num_layers, batch_size, self.rnn.hidden_size, device=self.fc.weight.device)
        c = zeros(self.rnn.num_layers, batch_size, self.rnn.hidden_size, device=self.fc.weight.device)
